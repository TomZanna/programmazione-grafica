...
int main() {
  ...
  glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float),
                        (void *)0); // store xyz coord in attrib 0
  glEnableVertexAttribArray(0);     // enable attrib 0 for the GPU

  glBindBuffer(GL_ARRAY_BUFFER, 0); // unbind VBO
  // #error glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0); // keep the EBO bound
