...
double lastCursorPositionX, lastCursorPositionY, cursorPositionX,
    cursorPositionY;
...
/////////////////////////////////////////////////////////////////////////////////////////////
static void key_callback(GLFWwindow *window, int key, int cancode, int action,
                         int mods) {
...
void update(float t) {
  ...
  // Using a different way (i.e. instead of callback) to check for LEFT mouse
  // button
  if (glfwGetMouseButton(window, GLFW_MOUSE_BUTTON_LEFT)) {
    // std::cout << "Left button \n";
    // Rotate the camera. The 0.001f is a velocity mofifier to make the speed
    // sensible
  ...
  // Using a different way (i.e. instead of callback) to check for RIGHT mouse
  // button
  if (glfwGetMouseButton(window, GLFW_MOUSE_BUTTON_RIGHT)) {
    // std::cout << "Right button \n";
    // Rotate the camera. The 0.01f is a velocity mofifier to make the speed
    // sensible
...
// resize
/////////////////////////////////////////////////////////////////////////////////////////////
void resizeGL(QuatCamera camera, int w, int h) { scene->resize(camera, w, h); }
